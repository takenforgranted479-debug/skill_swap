...
urlpatterns = [
    ...
    path('category/<int:category_id>/skills/', views.CategorySkillsView.as_view(), name='category_skills'),
    path('skill/<int:skill_id>/teachers/', views.SkillTeachersView.as_view(), name='skill_teachers'),
